...
/**
 * Implements properties and methods common to all (non-SPL) Checkout exceptions.
 */
abstract class ApiErrorException extends \Exception implements ExceptionInterface
{
     ...
     * @param string|null $stripeCode The Checkout error code.
     *
     * @return static
     */
    ...
    /**
     * Gets the Checkout error object.
     *
    ...
    /**
     * Sets the Checkout error object.
     *
