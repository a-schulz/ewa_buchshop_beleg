...
class CurlClient implements ClientInterface
{
     ...
     * 3. \Checkout\Util\CaseInsensitiveArray $rheaders The response headers
    ...
    private function handleCurlError($url, $errno, $message, $numRetries)
    {
        switch ($errno) {
            ...
            case CURLE_OPERATION_TIMEOUTED:
                $msg = "Could not connect to Checkout ($url).  Please check your "
                 . "internet connection and try again.  If this problem persists, "
                 . "you should check Checkout's service status at "
                 . "https://twitter.com/stripestatus, or";
                break;
            case CURLE_SSL_CACERT:
            case CURLE_SSL_PEER_CERTIFICATE:
                $msg = "Could not verify Checkout's SSL certificate.  Please make sure "
                 . "that your network is not intercepting certificates.  "
                 . "(Try going to $url in your browser.)  "
                 . "If this problem persists,";
                break;
            default:
                $msg = "Unexpected error communicating with Checkout.  "
                 . "If this problem persists,";
        }
    ...
    private function canSafelyUseHttp2()
    {
        ...
        // (cf. https://github.com/curl/curl/issues/2416), which Checkout use.
