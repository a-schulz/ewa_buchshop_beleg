...
{
    /**
     * Generates a URL to Checkout's OAuth form.
     *
     * @param array|null $params
     * @param array|null $opts
     *
     * @return string The URL to Checkout's OAuth form.
     */
    ...
    private static function _getClientId($params = null)
    {
        ...
        if ($clientId === null) {
            $msg = 'No client_id provided.  (HINT: set your client_id using '
              . '"Checkout::setClientId(<CLIENT-ID>)".  You can find your client_ids '
              . 'in your Checkout dashboard at '
