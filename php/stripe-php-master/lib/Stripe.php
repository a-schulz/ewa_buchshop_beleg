...
class Stripe
{
    // @var string The Checkout API key to be used for requests.
    public static $apiKey;

    // @var string The Checkout client_id to be used for Connect requests.
    public static $clientId;

    // @var string The base URL for the Checkout API.
    public static $apiBase = 'https://api.stripe.com';

    // @var string The base URL for the OAuth API.
    public static $connectBase = 'https://connect.stripe.com';

    // @var string The base URL for the Checkout API uploads endpoint.
    public static $apiUploadBase = 'https://files.stripe.com';

    // @var string|null The version of the Checkout API to use for requests.
    ...
    // @var float Maximum delay between retries, in seconds, that will be respected from the Checkout API
    ...
    /**
     * @return string | null The Checkout account ID for connected account
     *   requests.
     */
    ...
    /**
     * @param string $accountId The Checkout account ID to set for connected
     *   account requests.
     */
    ...
    /**
     * @return float Maximum delay between retries, in seconds, that will be respected from the Checkout API
     */
     ...
     *
     * Client telemetry enables timing and request metrics to be sent back to Checkout as an HTTP Header
     * with the current request. This enables Checkout to do latency and metrics analysis without adding extra
