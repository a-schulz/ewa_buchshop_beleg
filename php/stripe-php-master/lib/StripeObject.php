...
class StripeObject implements \ArrayAccess, \Countable, \JsonSerializable
{
    ...
    public function &__get($k)
    {
        ...
        if (!empty($this->_values) && array_key_exists($k, $this->_values)) {
            ...
            $message = "Checkout Notice: Undefined property of $class instance: $k. "
                    . "HINT: The $k attribute was set in the past, however. "
                    . "It was then wiped when refreshing the object "
                    . "with the result returned by Checkout's API, "
            ...
            $class = get_class($this);
            Stripe::getLogger()->error("Checkout Notice: Undefined property of $class instance: $k");
            return $nullval;
        }
    }
    ...
    /**
     * Returns a pretty JSON representation of the Checkout object.
     *
     * @return string The JSON representation of the Checkout object.
     */
    ...
    /**
     * @return object The last response from the Checkout API
     */
    ...
    /**
     * Sets the last response from the Checkout API
     *
