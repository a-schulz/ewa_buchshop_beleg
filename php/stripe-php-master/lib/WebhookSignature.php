...
abstract class WebhookSignature
{
    ...
    /**
     * Verifies the signature header sent by Checkout. Throws an
     * Exception\SignatureVerificationException exception if the verification fails for
     * any reason.
     *
     * @param string $payload the payload sent by Checkout.
     ...
     *
     * The current scheme used by Checkout ("v1") is HMAC/SHA-256.
     *
